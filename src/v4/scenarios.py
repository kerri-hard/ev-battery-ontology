...
SCENARIO_LIBRARY: list[dict[str, Any]] = [
    ...
    # ──────────────────────────────────────────────────────────
    # ──────────────────────────────────────────────────────────
    # SCN-016: 검사기 캘리브레이션 드리프트 (degradation, defect_mode_match)
    # ──────────────────────────────────────────────────────────
    {
        "id": "SCN-016",
    ...
    # ──────────────────────────────────────────────────────────
    # SCN-017: 셀 공급사 LOT 품질 편차 (single, material_anomaly)
    # ──────────────────────────────────────────────────────────
    {
        "id": "SCN-017",
    ...
    # ──────────────────────────────────────────────────────────
    # SCN-018: 클린룸 파티클 증가 (environmental, yield_drop)
    # ──────────────────────────────────────────────────────────
    {
        "id": "SCN-018",
        "name": "클린룸 파티클 카운트 증가",
    ...
    # ──────────────────────────────────────────────────────────
    # SCN-019: 컨베이어 속도 편차 (degradation, process_variation)
    # ──────────────────────────────────────────────────────────
    {
        "id": "SCN-019",
        "name": "공정 컨베이어 속도 편차",
    ...
    # ──────────────────────────────────────────────────────────
    # SCN-020: 공압 시스템 압력 누설 (cascading, pressure_drop)
    # ──────────────────────────────────────────────────────────
    {
        "id": "SCN-020",
        "name": "공압 시스템 압력 누설",
